...
export default function HomePage() {
  return (
    <main className="bg-iris-golden text-iris-charcoal">
      {/* Hero mit Bild */}
      <section
        className="relative h-[calc(100vh+5rem)] overflow-hidden bg-center bg-cover flex flex-col justify-center items-center text-center pb-20 mb-[-4px]"
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-7 px-6">
          ...
          >
            ...
            <span className="block md:inline">Ankommen.</span>
          </motion.h1>
