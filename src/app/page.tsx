    ...
    <main className="bg-iris-golden text-iris-charcoal">
      ...
      >
        ...
        <motion.div
          ...
          className="relative z-10 bg-iris-golden/70 backdrop-blur-sm max-w-2xl w-[92vw] md:w-full flex flex-col items-center text-center gap-6 shadow-xl overflow-hidden px-12 py-16 md:px-[3.5rem] md:py-[4.5rem]"
