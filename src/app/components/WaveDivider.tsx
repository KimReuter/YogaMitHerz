...
export default function WaveDivider({ fill, className = '', flip = false }: WaveDividerProps) {
  return (
    <div
      aria-hidden
      className={`w-full leading-none -mb-px ${flip ? 'rotate-180' : ''} ${className}`}
    >
      <svg
        viewBox="0 0 1440 80"
      ...
      >
        <path
          d="M0,50 C360,80 1080,10 1440,50 L1440,83 L0,83 Z"
          fill={fill}
          fillOpacity="0.4"
        />
        <path
          d="M0,40 C480,0 960,80 1440,40 L1440,83 L0,83 Z"
          fill={fill}
        />
      </svg>
    </div>
