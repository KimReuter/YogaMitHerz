...
const variantClasses: Record<Variant, string> = {
  primary:  'bg-iris-terracotta text-white hover:bg-iris-terracotta/80 hover:text-white border-2 border-transparent',
  outline:  'border-2 border-iris-terracotta text-iris-terracotta hover:bg-iris-terracotta hover:text-white',
  inverted: 'bg-white text-iris-terracotta hover:bg-iris-terracotta hover:text-white border-2 border-transparent',
};
